...
// Uses @libsql/client batch API for DDL (correct approach for Turso)
...
router.post('/', async (req, res) => {
    ...
    try {
        // Dynamically import createClient to use the same version drizzle uses
        ...
        const statements = [
            ...
            `CREATE TABLE IF NOT EXISTS leads (
                ...
                notes TEXT, is_archived INTEGER DEFAULT 0, archived_at INTEGER,
        ...
        // Use batch for atomic DDL execution
        ...
        if (count === 0) {
            ...
            await client.execute({
                sql: 'INSERT INTO users (id, name, email, password_hash, role, is_active, can_manage_users) VALUES (?, ?, ?, ?, ?, ?, ?)',
